...
use app\assets\admin\maps\GoogleAsset;

/* @var $this \yii\web\View */
/* @var $content string */

GoogleAsset::register($this);
$this->title = 'GOOGLE MAPS | BLANKON - Fullpack Admin Theme';
?>
...
<section id="page-content">
                ...
                <div class="header-content">
                    <h2><i class="fa fa-map-marker"></i> Google Map <span>google map samples</span></h2>
