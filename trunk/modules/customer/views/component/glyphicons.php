...
use app\assets\admin\component\GlyphAsset;

GlyphAsset::register($this);

$this->title = 'GLYPHICONS | BLANKON - Fullpack Admin Theme';
?>
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="fa fa-paw"></i> Glyphicons <span>icon components</span></h2>
