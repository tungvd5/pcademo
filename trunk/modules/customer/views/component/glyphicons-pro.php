...
use app\assets\admin\component\GlyphProAsset;

GlyphProAsset::register($this);

$this->title = 'GLYPHICONS PRO | BLANKON - Fullpack Admin Theme';
?>
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="fa fa-plus-square"></i> Glyphicons Pro <span>icon components</span></h2>
        <div class="breadcrumb-wrapper hidden-xs">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">glyphicons Pro</li>
            </ol>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="callout callout-info mb-20">
                    <p class="no-margin"><a href="http://glyphicons.com/" target="_blank">GLYPHICONS</a> is a library of precisely prepared monochromatic icons and symbols, created with an emphasis on simplicity and easy orientation. All icons in double size, All icons in vectors, All icons as a font, 470 GLYPHICONS, 260 GLYPHICONS Filetypes, 200 GLYPHICONS Halflings, 50 GLYPHICONS Social. <strong>$59 worth!</strong></p>
                    <p class="mb-5"><span class="label label-info">PNG</span>&nbsp;<span class="label label-info">@2x</span>&nbsp;<span class="label label-info">PSD</span>&nbsp;<span class="label label-info">AI</span>&nbsp;<span class="label label-info">PDF</span>&nbsp;<span class="label label-info">SVG</span>&nbsp;<span class="label label-info">OTF</span>&nbsp;<span class="label label-info">TTF</span>&nbsp;<span class="label label-info">EOT</span>&nbsp;<span class="label label-info">WOFF</span>&nbsp;<span class="label label-info">CSS</span>&nbsp;<span class="label label-info">HTML</span></p>
                </div>

                <div class="panel rounded shadow">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h3 class="panel-title">GLYPHIC<i class="fa fa-plus-square text-danger no-margin"></i>NS <span class="text-danger">PRO</span> <strong>$59</strong></h3>
                        </div>
                    ...
                    <div class="panel-body">
                        <div class="bs-glyphicons-pro-list">
