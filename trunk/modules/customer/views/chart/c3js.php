...
use app\assets\admin\chart\C3JsAsset;

C3JsAsset::register($this);

$this->title = ' C3JS CHARTS | BLANKON - Fullpack Admin Theme';
?>
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="fa fa-signal"></i> C3js chart <span>visual charts & graphs</span></h2>
