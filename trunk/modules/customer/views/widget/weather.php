...
use app\assets\admin\widget\WeatherAsset;

WeatherAsset::register($this);

$this->title = 'WHEATER WIDGET | BLANKON - Fullpack Admin Theme';
            ...
            <div class="col-md-9 col-sm-12">
                <div class="widget-wrapper rounded shadow">
                    <div class="weather-forecast">
                        <div class="row">
                            <div class="col-md-12">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/building/4.jpg" alt="..." height="240">
                                <div class="title">
                                    weather forecast
                                </div><!-- /.title -->
