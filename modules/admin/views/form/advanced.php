...
use app\assets\admin\form\AdvancedAsset;

AdvancedAsset::register($this);

$this->title = 'FORM ADVANCED | BLANKON - Fullpack Admin Theme';
?>
            ...
            <div class="col-md-12">
                ...
                <div class="panel rounded shadow">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="../../../assets/admin/data" class="dropzone">
                            <div class="fallback">
