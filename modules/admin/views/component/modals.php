...
use app\assets\admin\component\ModalsAsset;

ModalsAsset::register($this);

$this->title = 'MODALS | BLANKON - Fullpack Admin Theme';
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/6.png" class="img-circle img-bordered-theme" alt="...">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/7.png" class="img-circle img-bordered-theme" alt="...">
                                        <span>Kim Mbako</span>
                                    </td>
                                    <td>Angola</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/8.png" class="img-circle img-bordered-theme" alt="...">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 modal-photo-left">
                    <div class="modal-photo">
                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/animals/2.jpg" class="photo img-responsive" alt="...">
                    </div>
