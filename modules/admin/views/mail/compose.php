...
$this->title = "MAIL COMPOSE | BLANKON - Fullpack Admin Theme";
                        ...
                        <div class="panel-sub-heading inner-all">
                            <div class="pull-left">
                                <ul class="list-inline no-margin">
                                    <li>
                                        <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/mail/inbox') ?>" class="btn btn-danger btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
                                    </li>
                                    <li class="hidden-xs">
