...
use app\assets\admin\component\WheatherIconsAsset;

WheatherIconsAsset::register($this);

$this->title = 'WHEATHER ICONS | BLANKON - Fullpack Admin Theme';
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="wi wi-day-sunny-overcast"></i> Weather Icons <span>icon components</span></h2>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="callout callout-info mb-20">
                    <p><a href="http://erikflowers.github.io/weather-icons/" target="_blank">Weather Icons</a> is a font of <strong>123</strong> weather themed icons, ready to be dropped right into Bootstrap or any other project.</p>
                </div>
                <!-- Start new v1.2  -->
