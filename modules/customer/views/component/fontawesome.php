...
use app\assets\admin\component\FontAwesomeAsset;

FontAwesomeAsset::register($this);

$this->title = 'FONT AWESOME | BLANKON - Fullpack Admin Theme';
?>
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="fa fa-paw"></i> Font Awesome <span>icon components</span></h2>
    ...
    <div class="callout callout-info mb-20">
        <p><a href="http://fortawesome.github.io/Font-Awesome/" target="_blank">Font Awesome</a> gives you scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS.</p>
    </div>
