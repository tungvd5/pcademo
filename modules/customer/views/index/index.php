<section class="slider-section">
                ...
                <div class="tp-banner">
                    <ul>
                        <li data-transition="fade" data-slotamount="1" data-masterspeed="500" data-thumb="upload/slider_bg.jpg"  data-saveperformance="off"  data-title="Slide">
                            <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_bg.jpg"  alt="fullslide1"  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                            <div class="tp-caption slider_layer_03 lft tp-resizeme rs-parallaxlevel-9"
                                ...
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_01.png">
                            </div>
                            <div class="tp-caption slider_layer_03 lft tp-resizeme rs-parallaxlevel-9"
                                data-x="360"
                                data-y="100" 
                                ...
                                data-endelementdelay="0.1"
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_02.png">
                            </div>
                            <div class="tp-caption slider_layer_03 lft tp-resizeme rs-parallaxlevel-9"
                                data-x="center"
                                data-y="120" 
                                ...
                                data-endelementdelay="0.1"
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_03.png">
                            </div>
                            <div class="tp-caption slider_layer_03 lft tp-resizeme rs-parallaxlevel-9"
                                data-x="890"
                                data-y="380" 
                                ...
                                data-endelementdelay="0.1"
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_04.png">
                            </div>
                            <div class="tp-caption slider_layer_03 hide-on-mobile lft tp-resizeme rs-parallaxlevel-9"
                                ...
                                data-endelementdelay="0.1"
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_05.png">
                            </div>
                            <div class="tp-caption slider_layer_03 lft tp-resizeme rs-parallaxlevel-9"
                                data-x="0"
                                data-y="120" 
                                ...
                                data-endelementdelay="0.1"
                                data-endspeed="1000"
                                style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><img src="<?= \Yii::getAlias('@asset') ?>/customer/images/dummy.png" alt="" data-lazyload="<?= \Yii::getAlias('@asset') ?>/customer/upload/slider_06.png">
                            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12 nopadding bigbanner wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/banner-left.png" alt="" class="img-responsive"></a>
                    </div><!-- end 12 -->
                    <div class="col-md-6 col-sm-6 col-xs-12 nopadding bigbanner wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/banner-right.png" alt="" class="img-responsive"></a>
                    </div><!-- end 12 -->
                </div><!-- end row -->
            </div><!-- end container -->
        </section><!-- end section -->
            ...
            <div class="container">
                <div id="owl-client">
                    <div class="owl-client-item">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/client_01.png" alt="" class="img-responsive"></a>
                    </div><!-- end owl item -->

                    <div class="owl-client-item">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/client_02.png" alt="" class="img-responsive"></a>
                    </div><!-- end owl item -->

                    <div class="owl-client-item">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/client_03.png" alt="" class="img-responsive"></a>
                    </div><!-- end owl item -->

                    <div class="owl-client-item">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/client_04.png" alt="" class="img-responsive"></a>
                    </div><!-- end owl item -->

                    <div class="owl-client-item">
                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/client_05.png" alt="" class="img-responsive"></a>
                    </div><!-- end owl item -->
                </div><!-- end owl -->
            </div><!-- end container -->
        </section><!-- end section -->
                ...
                <div id="gallery">
                    <div class="portfolio">
                        <div class="item-w1 item-h1 box cat1">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_01.png" alt="" class="img-responsive">
                                <div class="magnifier">
                        ...
                        <div class="item-w1 item-h1 box cat2">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_02.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w2 item-h1 box cat3">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_03.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w1 item-h1 box cat1">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_04.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w1 item-h1 box cat2">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_05.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w2 item-h1 box cat3">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_06.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w2 item-h1 box cat2">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_08.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
                        ...
                        <div class="item-w2 item-h1 box cat1">  
                            <div class="entry">
                                <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/masonry_07.png" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <h4><a href="tour-single.html" title=""><span>Santis</span> Mount</a></h4>
                                    <div class="visible-buttons">
                                        <div class="shopbuttons">
        ...
        <section class="parallax fullscreen" data-parallax="scroll" data-image-src="<?= \Yii::getAlias('@asset') ?>/customer/upload/parallax_01.jpg">
            <div class="bannerbefore"></div>
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="testi-item">
                            <img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/testi_01.png" alt="" class="alignleft">
                            <div class="clearfix">
            ...
            <div class="container">
                ...
                <div id="homeblog" class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <article class="blog-wrap">
                            <div class="entry blog-media">
                                <a href="single.html"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/home_blog_01.jpg" class="img-responsive" alt=""></a>
                            </div><!-- end blog media -->
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <article class="blog-wrap">
                            <div class="entry blog-media">
                                <a href="single.html"><img src="<?= \Yii::getAlias('@asset') ?>/customer/upload/home_blog_02.jpg" class="img-responsive" alt=""></a>
                            </div><!-- end blog media -->
